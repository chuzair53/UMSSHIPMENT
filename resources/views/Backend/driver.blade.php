                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('store-driver') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="exampleInputPassword1" type="password" class="input-password form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
