...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('Import Update') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('shipment-import-update') }}" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row">
                            <label for="Excel File"
                                class="col-md-4 col-form-label text-md-right">{{ __('Update Excel File') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    {{ __('Import Shipment Update') }}
                                </button>
                            </div>
                        </div>

                         <div class="instruction mt-5">
                             <h3>Instructions on how to Update Import Shipment</h3>
                             <ol>
